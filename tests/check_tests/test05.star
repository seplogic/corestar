...
{
   ($g_queue_event_0_position_0 != "return_$$_java.util.Iterator.next$$$$java.lang.Object") *
   ($g_queue_event_0_position_0 = _parameter0_4) *
   ($g_current_automaton_state = "simplestart") *
   ($g_queue_event_0_position_0 != "call_$$_java.util.Iterator.next$$$$java.lang.Object") *
   ($g_current_automaton_state = _$g_current_automaton_state_2) *
